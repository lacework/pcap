...
func TestDecodeSimpleDns(t *testing.T) {
	pkt := &Packet{
		Data: []byte{
			0x00, 0x25, 0xb5, 0xe2, 0x00, 0xbf, 0x54, 0xe0, 0x32, 0xca, 0xfd, 0xf0, 0x81, 0x00, 0x00, 0x00,
			0x08, 0x00, 0x45, 0x00, 0x00, 0x55, 0xff, 0x71, 0x40, 0x00, 0x3c, 0x11, 0xd7, 0xbd, 0xd0, 0x43,
			0xde, 0xde, 0xcc, 0xc2, 0xeb, 0x83, 0x00, 0x35, 0x82, 0xdd, 0x00, 0x41, 0xae, 0xc4, 0xa8, 0x09,
			0x81, 0x80, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x05, 0x76, 0x61, 0x75, 0x6c, 0x74,
			0x07, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x05, 0x73, 0x74, 0x72, 0x6c, 0x6e, 0x03, 0x6e,
			0x65, 0x74, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x09,
			0x31, 0x00, 0x04, 0x92, 0x70, 0xff, 0x0f,
		}}
	pkt.Decode()

	fmt.Printf("DNS Data %v %+v %+v %+v\n", pkt.Headers_cnt, pkt, pkt.iphdr, pkt.Payload)
}
...
func TestDecodeTruncatedUpperLayer(t *testing.T) {
	...
	p := &Packet{
		Data: []byte{
			0x00, 0x00, 0x0c, 0x9f, 0xf0, 0x20, 0xbc, 0x30, 0x5b, 0xe8, 0xd3, 0x49,
			0x08, 0x00, 0x45, 0x00, 0x01, 0xa4, 0x39, 0xdf, 0x40, 0x00, 0x40, IP_TCP,
	...
	p = &Packet{
		Data: []byte{
			0x00, 0x00, 0x0c, 0x9f, 0xf0, 0x20, 0xbc, 0x30, 0x5b, 0xe8, 0xd3, 0x49,
			0x08, 0x00, 0x45, 0x00, 0x01, 0xa4, 0x39, 0xdf, 0x40, 0x00, 0x40, IP_ICMP,
			0x55, 0x5a, 0xac, 0x11, 0x51, 0x49, 0xad, 0xde, 0xfe, 0xe1, 0xc5,
		}}
	p.Decode()
	...
	p = &Packet{
		Data: []byte{
			0x00, 0x00, 0x0c, 0x9f, 0xf0, 0x20, 0xbc, 0x30, 0x5b, 0xe8, 0xd3, 0x49,
			0x08, 0x00, 0x45, 0x00, 0x01, 0xa4, 0x39, 0xdf, 0x40, 0x00, 0x40, IP_UDP,
			0x55, 0x5a, 0xac, 0x11, 0x51, 0x49, 0xad, 0xde, 0xfe, 0xe1, 0xc5,
		}}
	p.Decode()
}
